...
class CityStatsTests(test.TestCase):
    ...
    def test_city_stats_center_methods(self):
        ...
        self.assertEqual(self.city_stats.energy_bilans, 4)
        self.assertEqual(self.city_stats.energy_allocation, 0)
        self.assertEqual(self.city_stats.energy_production, 4)
        self.assertEqual(self.city_stats.water_bilans, 20)
        self.assertEqual(self.city_stats.water_allocation, 0)
        self.assertEqual(self.city_stats.water_production, 20)
