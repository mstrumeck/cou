...
class CityViewTests(CityFixture):
    ...
    def test_total_clean_water_production_view(self):
        ...
        self.assertTrue(
            response,
            "Oczyszczona woda: {}".format(self.city_stats.clean_water_production),
        )
    ...
    def test_total_raw_water_production_view(self):
        ...
        self.assertTemplateUsed(response, "main_view.html")
        self.assertTrue(
            response, "Surowa woda: {}".format(self.city_stats.raw_water_production)
        )
...
class ModelsTests(test.TestCase, TestHelper):
    ...
    def test_pollution_calculations(self):
        ...
        wind_plant = WindPlant.objects.create(
            city=self.city,
        ...
        self.assertEqual(
            wind_plant.pollution_calculation(
