    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profession_type_provided",
                    models.CharField(default="Farmer fasoli", max_length=30),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cash",
                    models.DecimalField(
                        decimal_places=2, default=1000000, max_digits=20
                    ),
                ),
                (
                    "mass_price",
                    models.DecimalField(decimal_places=2, default=2, max_digits=20),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(default="Elektrownia węglowa", max_length=20),
                ),
                (
                    "profession_type_provided",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profession_type_provided",
                    models.CharField(default="Śmieciarz", max_length=30),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profession_type_provided",
                    models.CharField(default="Farmer sałaty", max_length=30),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profession_type_provided",
                    models.CharField(default="Farmer ziemniaków", max_length=30),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "education_type_provided",
                    models.CharField(default="EL", max_length=8),
                ),
                (
                    "profession_type_provided",
                    models.CharField(default="Nauczyciel", max_length=10),
                ),
                (
                    "qualification_needed",
                    models.CharField(default="COL", max_length=10),
                ),
                (
                    "city",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(default="Elektrownia na ropę", max_length=20),
                ),
                (
                    "profession_type_provided",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(default="Oczyszczalnia ścieków", max_length=30),
                ),
                (
                    "profession_type_provided",
                    models.CharField(default="Pracownik oczyszczalni", max_length=30),
                ),
                ("build_time", models.PositiveIntegerField(default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="Normalna dzielnica mieszkalna", max_length=30
                    ),
                ),
                (
                    "city",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profession_type_provided",
                    models.CharField(default="Pracownik wieży ciśnień", max_length=30),
                ),
                ("build_time", models.PositiveIntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(default="Elektrownia wiatrowa", max_length=20),
                ),
                (
                    "profession_type_provided",
                    models.CharField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="city_engine.City"
            ),
        ),
        migrations.AddField(
            model_name="beanfarm",
            name="city_field",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="city_engine.CityField"
            ),
        ),
    ]
