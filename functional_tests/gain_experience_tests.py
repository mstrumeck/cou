...
class CitizenBasicTests(BaseTest):
    ...
    def test_school_assign(self):
        ...
        self.assertEqual(RC.citizens_in_city[self.teacher].current_profession.proficiency, 0.02)
        ...
        main_view.next_turns(1)
        RC = RootClass(self.city, self.user)
        self.assertEqual(RC.citizens_in_city[self.student_one].current_education.effectiveness, 0.00416)
        self.assertEqual(RC.citizens_in_city[self.student_two].current_education.effectiveness, 0.00416)
