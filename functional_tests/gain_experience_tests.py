...
class CitizenBasicTests(BaseTest):
    ...
    def test_school_assign(self):
        ...
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].cur_level, 0.04)
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].level, TRAINEE)
        ...
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].cur_level, 0.06)
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].level, TRAINEE)
        ...
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].cur_level, 0.08)
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].level, TRAINEE)
        ...
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].cur_level, 0.1)
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].level, TRAINEE)
        ...
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].cur_level, 0.12)
        self.assertEqual(RC.citizens_in_city[self.teacher]['current_profession'].level, JUNIOR)
