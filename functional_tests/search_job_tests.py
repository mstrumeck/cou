...
class SearchJobTest(BaseTest):
    ...
    def setUp(self):
        ...
        Education.objects.create(citizen=self.employee, name=ELEMENTARY, effectiveness=1, if_current=False)
        Education.objects.create(citizen=self.employee, name=COLLEGE, effectiveness=1, if_current=False)
        Education.objects.create(citizen=self.m, name=ELEMENTARY, effectiveness=1, if_current=False)
